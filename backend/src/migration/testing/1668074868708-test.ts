...
export class test1668074868708 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `INSERT INTO "user" ("id", "firstName", "lastName", "email", "phoneNumber", "role")
        ...
        ('35df7121-a675-4969-8cc5-bdbdfb53810f', 'Ignacy', 'Woźniak', 'usr4@EKRABSCSBIJIUEDPXVVK.com', '787371335', 'user')
      ;`
    );
    ...
    await queryRunner.query(
      `INSERT INTO "schedule" ("id", "start", "end", "forId")
        VALUES
        ('b5926670-6e3b-4c84-8a14-d907ca072d07', '2022-12-01 08:00:00', '2022-12-01 11:00:00', '634dc798-9608-405e-8e95-94095d91fb73'),
    ...
    await queryRunner.query(
      `INSERT INTO "visit" ("id", "start", "end", "bookedById", "servicedById")
        VALUES
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DELETE FROM "user"
        WHERE "id" IN (
          'c9c70c2c-ca36-498c-91e4-d51b67f3c1dd',
          '634dc798-9608-405e-8e95-94095d91fb73',
          '244e757c-9d58-4be3-bc21-ac46953be644',
          'd32cff38-8813-48da-9df0-1fe3a83287e8',
          '2176b3f7-f58a-45d3-837a-ba93dca5e872',
          'd2aab8be-7de5-4ffc-9fbc-41817b1cb4d3',
          '35df7121-a675-4969-8cc5-bdbdfb53810f'
        );`
    );
    ...
    await queryRunner.query(
      `DELETE FROM "schedule"
        WHERE "id" IN (
          'b5926670-6e3b-4c84-8a14-d907ca072d07',
          '6f11ef42-515f-4a26-8a52-730e0f64d529',
          'e6cfbc8e-bd07-4a8d-a360-429b67e61d1f',
          'b52d6d44-214c-448c-80f4-5966536bd5a9'
      );`
    );
    ...
    await queryRunner.query(
      `DELETE FROM "visit"
        WHERE "id" IN (
          'a88987c1-59ab-4e0e-a205-9de7c0458b0e',
          '14ff7f01-2651-4e6f-bcf7-15b7e75b9ca9',
          '3edcf7d2-2a99-4756-8a6c-6ec4cc08ee03',
          '2eaa34b6-379a-4820-ae41-3e9cf6dc812b'
      );`
    );
  }
}
